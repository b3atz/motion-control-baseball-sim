...
export class Migration20250518175204 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`game\` (\`id\` integer not null primary key autoincrement, \`home_id\` integer not null, \`away_id\` integer not null, constraint \`game_home_id_foreign\` foreign key(\`home_id\`) references \`team\`(\`id\`) on update cascade, constraint \`game_away_id_foreign\` foreign key(\`away_id\`) references \`team\`(\`id\`) on update cascade);`);
